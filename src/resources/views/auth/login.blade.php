    ...
    <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-6 col-md-9">
            <div class="card o-hidden border-0 shadow-lg my-5">            
                <div class="card-header">{{ __('Alp Learning-Login') }}</div>
                <div class="card-body">
                    <form class="user" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6"style="margin-right:auto; margin-left:auto;">
                                <label for="password" class="col-md-6 col-form-label text-md-left">{{ __('Contraseña') }}</label>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4" style="margin-left:10rem;">
